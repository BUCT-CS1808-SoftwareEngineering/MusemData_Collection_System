...
class Education189Spider(scrapy.Spider):
    ...
    start_urls = ['https://www.tjnhm.com/index.php?p=jyhd_show&id=2092&lanmu=&c_id=5']
    ...
    def parse(self, response):
        try:
            ...
            img = 'https://www.tjnhm.com/' + response.xpath('//*[@style="text-align:center;"][1]/img/@src').extract_first()
