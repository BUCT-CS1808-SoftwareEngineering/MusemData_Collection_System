...
#                 self.cursor.execute('insert into `collection info table`(muse_ID,col_Name,col_Intro,col_Photo) values("%d","%s",\"%s\","%s")'%(item["museumID"],item["collectionName"],escape_string(item["collectionIntroduction"]),item["collectionImage"]))
#                 self.conn.commit()
...
#                 # self.cursor.execute('delete from `exhibition info table` where muse_ID = ("%d")'%(item["museumID"]))
#                 self.cursor.execute('insert into `exhibition info table`(muse_ID,exhib_Name,exhib_Content,exhib_Pic) values("%d","%s",\"%s\","%s")'%(item["museumID"],item["exhibName"],escape_string(item["exhibIntro"]),item["exhibImg"]))
#                 self.conn.commit()
...
#                 # self.cursor.execute('delete from `education act table` where muse_ID = ("%d")'%(item["museumID"]))
#                 self.cursor.execute('insert into `education act table`(muse_ID,act_Name,act_Content,act_Pic) values("%d","%s",\"%s\","%s")'%(item["museumID"],item["eduName"],escape_string(item["eduContent"]),item["eduImg"]))
#                 self.conn.commit()
